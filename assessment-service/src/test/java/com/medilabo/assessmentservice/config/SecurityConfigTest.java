...
/**
 * Tests unitaires des beans de sécurité (SecurityConfig instancié directement, pas de contexte Spring).
 * Vérifie que le hash match le mot de passe brut — jamais stocké en double-encodé.
 */
class SecurityConfigTest {

    /** Identifiants démo DEV partagés avec Gateway, patient-service, notes-service et front-service. */
