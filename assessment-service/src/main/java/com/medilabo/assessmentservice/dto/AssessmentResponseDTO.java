 ...
 *
 * <p>FR-8 et FR-9 sont définis dans {@code Documentation/requirements-glossary.md} : FR-8 est
 * la forme de cette réponse, FR-9 les règles de calcul appliquées par {@code RiskCalculator}.</p>
 *
 * @param patId            id du patient évalué.
 * @param patient          bloc démographique imbriqué (prénom, nom, âge calculé).
 * @param riskBand         bande classifiée ; sérialisée en la chaîne exacte FR-8 via le
 *                         {@code @JsonValue} porté par {@link RiskBand#getDisplayName()}.
