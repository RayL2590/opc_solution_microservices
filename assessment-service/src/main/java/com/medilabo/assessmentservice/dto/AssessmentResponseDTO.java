...
/**
 * L'enveloppe HTTP renvoyée par {@code GET /assessments/{patId}} — enrichit le
 ...
 * @param riskBand         bande classifiée ; sérialisée en la chaîne exacte attendue sur le fil
 *                         via le {@code @JsonValue} porté par {@link RiskBand#getDisplayName()}.
