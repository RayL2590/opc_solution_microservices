 ...
 * @param matchPatterns motifs en minuscules qui comptent comme match ; en général un seul motif par terme, sauf <em>Fumeur</em> qui regroupe {@code fumeur}/{@code fumeuse} sous un seul déclencheur.
 */
