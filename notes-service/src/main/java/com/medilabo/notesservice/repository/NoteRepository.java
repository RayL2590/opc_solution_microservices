...
public interface NoteRepository extends MongoRepository<Note, String> {
    ...
    // Ça marche parce que l'ObjectId Mongo est monotone par insertion tant qu'on a un seul writer
    // (le cas aujourd'hui) — il encode même son propre timestamp dans les 4 premiers octets.
